...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x28cifu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x28cifu.containers.anotherwebservice.com/
...
```
git clone git@github.com:nekohacker591/container-x28cifu.git
cd container-x28cifu
```
...
```
docker attach container-x28cifu
```
